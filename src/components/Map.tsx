...
const defaultCenter = {lat: 50.5, lng: 30.5}
...
const Map = () => {
    ...
    const houses = useMemo<LatLngLiteral[]>(
        function () {
                ...
                <GoogleMap
                    ...
                    {directions && (
                        <DirectionsRenderer
                            ...
                            options={{polylineOptions: {zIndex: 50, strokeColor: '#1976D2', strokeWeight: 5}}}
                        />
                    )}

                    {office && (
                        <>
                            <Marker position={office} icon="https://img.icons8.com/color/48/000000/marker--v1.png" />
                            <MarkerClusterer>
                                {(clusterer) => (
                                    <>
                                        {houses.map((house) => (
